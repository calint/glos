...
//-----------------------------------------------------------------------------
#define objmtls_foo(ls,body)dynp_foreach_all(ls,({void __fn__ (objmtl* o) body __fn__;}))
#define objmtls_foa(ls,body)dynp_foreach_all(ls,({int __fn__ (objmtl* o) body __fn__;}))
//-----------------------------------------------------------------------------
